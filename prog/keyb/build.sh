...
i586-elf-ld -T link_bin.ld -nostdlib $(find . -name "*.o") $(find ../../libnop -name "*.o") -o keyb.nex
i586-elf-ld -T link_elf.ld -nostdlib $(find . -name "*.o") $(find ../../libnop -name "*.o") -o keyb.elf
